...
var dataFiles = _.chain(walkdir.sync(dataDir))
  .filter(function (dataPath) {
    return (
      path.extname(dataPath) === ".json" &&
      path.basename(dataPath, ".json") !== "defaults"
    )
  })
...
var fnWrapper = function (d) {
  return (
    "module.exports=function (o) {var _i=" +
    d +
    ";return _i[o.sport][o.year];};"
  )
}
