  ...
  for (var i = 0; i < 100; i++) {
    ;(function () {
      it("the created and flat brackets should be equal", function () {
        ...
        var bv = new BracketValidator({
          flatBracket: flat,
          year: year,
          sport: sport,
          testOnly: true,
        }).validate()
        var v = new BracketValidator({
          flatBracket: flat,
          year: year,
          sport: sport,
        }).validate()
...
describe("New validator has correct properties", function () {
  it("Has the four necessary properties and no more", function () {
    ...
    var expectedOwn = ["options", "bracketData", "flatBracket"]
...
describe("Final four", function () {
  it("Regions dont need to be set for final four to be set", function () {
    var bracket = "MW1XXXXXXX1XXX1X1 W16XXXXXXX16XXX16X16 SXXX13XXXXXXXXXXX EXXXX6XXXXX6XX66 FF MW E E".replace(
      /\s/g,
      ""
    )
    var validator = new BracketValidator({
  ...
  it("Teams cant win a game in final four without winning region", function () {
    var bracket = "MW1XXXXXXX1XXX1X1 W16XXXXXXX16XXX16X16 SXXX13XXXXXXXXXXX EXXXX6XXXXX6XX6X FF MW E E".replace(
      /\s/g,
      ""
    )
    var validator = new BracketValidator({
...
describe("Can be reset", function () {
  it("Teams cant win a game in final four without winning region", function () {
    ...
    validator.reset(
      "MW1XXXXXXX1XXX1X1 W16XXXXXXX16XXX16X16 SXXX13XXXXXXXXXXX EXXXX6XXXXX6XX66 FF MW E E".replace(
        /\s/g,
        ""
      )
    )
...
describe("Bad Brackets", function () {
  it("Champ game participants are illegal", function () {
    var bracket =
      "E185463721432121W185463721432121S185463721432121MW185463721432121FFSEE"
    var validator = new BracketValidator({
      flatBracket: bracket,
      year: year,
      sport: sport,
  ...
  it("There is a first round game missing", function () {
    var bracket =
      "EX85463721432121W185463721432121S185463721432121MW185463721432121FFSEE"
    var validator = new BracketValidator({
      flatBracket: bracket,
      year: year,
      sport: sport,
  ...
  it("There is a regional final missing", function () {
    var bracket =
      "E185463721432121W185463721432121S18546372143212XMW185463721432121FFSEE"
    var validator = new BracketValidator({
      flatBracket: bracket,
      year: year,
      sport: sport,
  ...
  it("Championship game participants are wtf", function () {
    var bracket =
      "E185463721432121W185463721432121S185463721432121MW185463721432121FFSNX"
    var validator = new BracketValidator({
      flatBracket: bracket,
      year: year,
      sport: sport,
  ...
  it("Wrong keys", function () {
    var bracket =
      "N185463721432121W185463721432121S185463721432121MW185463721432121FFXXX"
    var validator = new BracketValidator({
      flatBracket: bracket,
      year: year,
      sport: sport,
  ...
  it("Not subsets", function () {
    var bracket =
      "E185463721432121W185463721432123S185463721432121MW185463721432121FFXXX"
    var validator = new BracketValidator({
      flatBracket: bracket,
      year: year,
      sport: sport,
  ...
  it("Incorrect number of picks", function () {
    var bracket =
      "E185463721432121W18546372143212S185463721432121MW185463721432121FFXXX"
    var validator = new BracketValidator({
      flatBracket: bracket,
      year: year,
      sport: sport,
...
describe("NBA", function () {
  it("works with only two regions and with one region with winsIn", function () {
    var validator = new BracketValidator({
      flatBracket: "W1423121E17472737172717FW",
      year: "2016",
      sport: "nba",
    }).validate()
    ...
    assert.deepEqual(validator.E.winsIn, [[], [7, 7, 7, 7], [7, 7], [7]])
  })
})
...
describe("NHL", function () {
  it("works", function () {
    var validator = new BracketValidator({
      flatBracket: "C133P122M122A122FPMM",
      year: "2016",
      sport: "nhl",
    }).validate()
  ...
  it("works with number of games picks", function () {
    ...
    assert.deepEqual(validator.C.winsIn, [[], [4, 7], [7]])
    ...
    assert.deepEqual(validator.M.winsIn, [[], [4, 5], [6]])
  ...
  it("works with only first round number of picks", function () {
    var validator = new BracketValidator({
      flatBracket: "C14373P15262M14252A17262FPMM",
      year: "2016",
      sport: "nhl",
    }).validate()
    ...
    assert.deepEqual(validator.C.winsIn, [[], [4, 7], [null]])
    ...
    assert.deepEqual(validator.M.winsIn, [[], [4, 5], [null]])
...
describe("World Cup", function () {
  it("works", function () {
    var validator = new BracketValidator({
      flatBracket: "L1423121R1423121FL",
      year: "2018",
      sport: "wcm",
    }).validate()
  ...
  it("works with winsIn", function () {
    var validator = new BracketValidator({
      flatBracket: "L11422331112213R11422331112211FL1",
      year: "2018",
      sport: "wcm",
    }).validate()
    ...
    assert.deepEqual(validator.L.winsIn, [[], [1, 2, 3, 1], [1, 2], [3]])

    assert.deepEqual(validator.R.winsIn, [[], [1, 2, 3, 1], [1, 2], [1]])
  })
})
