...
describe("Bracket Updater", function () {
  it("Game should be updated", function () {
    var beforeBracket =
      "MW1812463721X3XXXXW191213614102XX6XXXXS1854113715X4XXXXXE191246372XXXXXXXFFXXX"
    var afterBracket =
      "MW1812463721123XXXXW191213614102XX6XXXXS1854113715X4XXXXXE191246372XXXXXXXFFXXX"
  ...
  it("Game should be updated", function () {
    var beforeBracket =
      "MW18124637211232XXXW191213614102XX6XXXXS1854113715X4XXXXXE191246372XXXXXXXFFXXX"
    var afterBracket =
      "MW18124637211232X3XW191213614102XX6XXXXS1854113715X4XXXXXE191246372XXXXXXXFFXXX"
    var u = new BracketUpdater({
      currentMaster: beforeBracket,
      fromRegion: "MW",
      winner: "3",
  ...
  it("Game should be updated", function () {
    var beforeBracket =
      "MW18124637211232123XW191213614102XX6XXXXS1854113715X4XXXXXE191246372XXXXXXXFFXXX"
    var afterBracket =
      "MW181246372112321233W191213614102XX6XXXXS1854113715X4XXXXXE191246372XXXXXXXFFXXX"
    var u = new BracketUpdater({
      currentMaster: beforeBracket,
      fromRegion: "MIDWEST",
      winner: { seed: 3 },
  ...
  it("Game should be updated even if bracket is unfinished", function () {
    ...
    var afterBracket =
      "MW185XXXXXX5XXXXXWXXXXXXXXXXXXXXXSXXXXXXXXXXXXXXXEXXXXXXXXXXXXXXXFFXXX"
    var u = new BracketUpdater({
      currentMaster: beforeBracket,
      fromRegion: "MIDWEST",
      winner: 5,
  ...
  it("Game should be updated even if bracket is unfinished", function () {
    var beforeBracket =
      "MW185XXXXXX5XXXXXWXXXXXXXXXXXXXXXSXXXXXXXXXXXXXXXEXXXXXXXXXXXXXXXFFXXX"
    var afterBracket =
      "MW185XXXXXX5XX5XXWXXXXXXXXXXXXXXXSXXXXXXXXXXXXXXXEXXXXXXXXXXXXXXXFFXXX"
    var u = new BracketUpdater({
      currentMaster: beforeBracket,
      fromRegion: "MW",
      winner: { name: "", seed: 5 },
  ...
  it("Game should be updated even if bracket is unfinished and the previous winning team has already advanced", function () {
    var beforeBracket =
      "MW18XXXXXX1XXXXXXWXXXXXXXXXXXXXXXSXXXXXXXXXXXXXXXEXXXXXXXXXXXXXXXFFXXX"
    var afterBracket =
      "MW168XXXXXXXXXXXXXWXXXXXXXXXXXXXXXSXXXXXXXXXXXXXXXEXXXXXXXXXXXXXXXFFXXX"
    var u = new BracketUpdater({
      currentMaster: beforeBracket,
      fromRegion: "MW",
      winner: { name: "", seed: 16 },
  ...
  it("Game should not be updated if we are only passing in a winner and that team has won all possible games", function () {
    var beforeBracket =
      "MW1XXXXXXX1XXX1X1WXXXXXXXXXXXXXXXSXXXXXXXXXXXXXXXEXXXXXXXXXXXXXXXFFXXX"
    var afterBracket =
      "MW1XXXXXXX1XXX1X1WXXXXXXXXXXXXXXXSXXXXXXXXXXXXXXXEXXXXXXXXXXXXXXXFFXXX"
    var u = new BracketUpdater({
      currentMaster: beforeBracket,
  ...
  it("Teams in final four should be removed when lost", function () {
    var beforeBracket =
      "MW1XXXXXXX1XXX1X1W1XXXXXXX1XXX1X1SXXXXXXX2XXX2X22EXXXXXXX2XXX2X22FFMWEX"
    var afterBracket =
      "MW1XXXXXXX1XXX1X1W1XXXXXXX1XXX1X1SXXXXXXX15XXXXXXXEXXXXXXX2XXX2X22FFMWEX"
    var u = new BracketUpdater({
      currentMaster: beforeBracket,
      fromRegion: "S",
      winner: 15,
  ...
  it("Teams in final four should be removed when lost", function () {
    var beforeBracket =
      "MW1XXXXXXX1XXX1X1W1XXXXXXX1XXX1X1SXXXXXXX2XXX2X22EXXXXXXX2XXX2X22FFMWEX"
    var afterBracket =
      "MW1XXXXXXX1XXX1X1W1XXXXXXX1XXX1X1SXXXXXXX2XXX2X22EXXXXXXX15XXXXXXXFFMWXX"
    var u = new BracketUpdater({
      currentMaster: beforeBracket,
      fromRegion: "E",
      winner: 15,
    ...
    var beforeBracket2 =
      "MW1XXXXXXX1XXX1X1W16XXXXXXX16XXX16X16SXXX4XXXXX4XX4X4EXXXX6XXXXX6XX66FFMWEX"
    var afterBracket2 =
      "MW1XXXXXXX1XXX1X1W16XXXXXXX16XXX16X16SXXX13XXXXXXXXXXXEXXXX6XXXXX6XX66FFMWEX"
  ...
  it("Should not update future games if a winner and loser is passed and that specific game has been recorded", function () {
    var before =
      "MWXXXXXX10XXXX10X1010WXXXXXXXXXXXXXXXS168XXXXXX8XXX8X8EXXXXXXXXXXXXXXXFFMWSS"
    var befor1 =
      "MWXXXXXX10XXXX10X1010WXXXXXXXXXXXXXXXS168XXXXXX16XXXXXXEXXXXXXXXXXXXXXXFFMWXX"
  ...
  it("Should update 1st FF game in 2015", function () {
    var beforeBracket =
      "MW185463721537131W18546141021462121E1854113728437477S185411147215112121FFXXX"
    var afterBracket1 =
      "MW185463721537131W18546141021462121E1854113728437477S185411147215112121FFXSX"
    var afterBracket2 =
      "MW185463721537131W18546141021462121E1854113728437477S185411147215112121FFMWSX"
  ...
  it("Should match array of team names from names prop too", function () {
    ...
    var u1 = new BracketUpdater({
      ...
      loser: {
        name: "Michigan St",
        names: ["MST", "Michigan State", "Michigan St"],
        seed: 7,
      },
      year: "2015",
      sport: sport,
...
describe("NBA", () => {
  ...
  it("Should be updated without a seed", function () {
    ...
    assert.equal(
      ...
      u.update({
        ...
        loser: {
          name: ["Pacers", "Indiana Pacers", "Pacers", "Indiana", "IND"],
        },
        playedCompetitions: 4,
        fromRegion: "eastern conference",
      })
  ...
  it("should update played competitions", () => {
    ...
    assert.equal(
      "W17472737172714E174727371727XFX",
      u.update({
        fromRegion: "W",
        winner: 1,
        loser: 2,
    ...
    assert.equal(
      "W17472737172714E17472737172715FX",
      u.update({
        fromRegion: "E",
        winner: 1,
        loser: 2,
    ...
    assert.equal(
      "W17472737172714E17472737172715FW7",
      u.update({
        fromRegion: "NBA FINALS",
        winner: { name: "Golden State", seed: 1 },
        loser: { name: "Cleveland", seed: 1 },
