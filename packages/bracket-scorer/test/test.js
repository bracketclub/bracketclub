...
describe('Bracket Scorer', function () {
  it('Should return rounds', function () {
    ...
    var random = new BracketGenerator({winners: 'lower', year: year, sport: sport})
    var scorer = new BracketScorer({
    ...
    var perf2 = new BracketGenerator({winners: 'higher', year: year, sport: sport}).generate()
  ...
  it('Worst score', function () {
    var noUpsets = new BracketGenerator({winners: 'lower', year: year, sport: sport})
    var allUpsets = new BracketGenerator({winners: 'higher', year: year, sport: sport})
    var s = new BracketScorer({
  ...
  it('Gooley with all upsets', function () {
    ...
    var master = new BracketGenerator({winners: 'higher', year: year, sport: sport})
    var s = new BracketScorer({
      entry: entry.generate(),
      master: master.generate(),
      sport: sport,
...
describe('Bracket Differ', function () {
  it('Should return an object', function () {
    var noUpsets = new BracketGenerator({winners: 'lower', year: year, sport: sport})
    var random = new BracketGenerator({winners: 'random', year: year, sport: sport})
    var s = new BracketScorer({
      entry: random.generate(),
      master: noUpsets.generate(),
      sport: sport,
