...
var events = [
  ...
  {
    bracket:
      "MW19513637291362966W169121311147216121421622E1681213631021612310121012S1691213637216123716316FFMWSMW",
    sport: "ncaam",
    year: "2015",
  },
  {
  ...
  {
    bracket:
      "B1854113721432131D185463721432131S185463721532131L1854113721532122FFBSB",
    sport: "ncaaw",
    year: "2016",
  },
  {
...
describe("Bracket Data", function () {
  it("valid regex brackets", function () {
    events.forEach(function (e) {
      ...
      assert.ok(
        b.regex.test(e.bracket),
        [b.regex, e.sport, e.year, e.bracket].join("--")
      )
    })
  })
})
