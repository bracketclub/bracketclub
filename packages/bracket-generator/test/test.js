...
var sport = "ncaam"
var chalk =
  "MW185463721432121W185463721432121S185463721432121E185463721432121FFMWSMW"
var upsets =
  "MW16912131114101516131415161516W16912131114101516131415161516S16912131114101516131415161516E16912131114101516131415161516FFWEE"
...
describe("Bracket generator", function () {
  ...
  it("generates a bracket from a binary string", function () {
    var generator = new BracketGenerator({
      year: year,
      sport: sport,
      winners: fullBracketBinary(4044),
    })
  ...
  it("Can be validated", function () {
    ...
    assert.equal(
      false,
      validator.validate(generator.generate("lower")) instanceof Error
    )
    assert.equal(
      false,
      validator.validate(generator.generate("higher")) instanceof Error
    )
  })
